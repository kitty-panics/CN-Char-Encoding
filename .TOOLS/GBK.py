        ...
        for j in range(start2, end2 + 1):
            if extra == '1' and j == 0x7f:
                ...
                try:
                    ...
                    #print(f'0x{gbc}\t{char}\t{unic}')
                    with open('../GBK.txt', 'a', encoding='utf-8') as f:
                        f.write(f'0x{gbc}\t{char}\t{unic}\n')
                except UnicodeDecodeError:
                    pass


convert2char(0xB0, 0xF7, 0xA1, 0xFE, 'GBK', '0') # GBK/2: B0–F7, A1–FE;              6768/6763
convert2char(0x81, 0xA0, 0x40, 0xFE, 'GBK', '1') # GBK/3: 81–A0, 40–FE (except: 7F); 6080/6080
convert2char(0xAA, 0xFE, 0x40, 0xA0, 'GBK', '1') # GBK/4: AA–FE, 40–A0 (except: 7F); 8160/8160
